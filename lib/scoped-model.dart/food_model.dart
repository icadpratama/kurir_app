import 'dart:convert';
import 'package:kurirapp/models/food_model.dart';
...
class FoodModel extends Model {
  ...
  Future<bool> updateFood(Map<String, dynamic> foodData, String foodId) async {
    ...
    try {
      await http.put(
          "https://foodie2-fe2c7.firebaseio.com/foods/${foodId}.json",
          body: json.encode(foodData));
  ...
  Future<bool> deleteFood(String foodId) async {
    ...
    try {
      final http.Response response = await http
          .delete("https://foodie2-fe2c7.firebaseio.com/foods/${foodId}.json");
